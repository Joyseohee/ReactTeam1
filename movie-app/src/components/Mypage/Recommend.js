...
function Recommend() {
    ...
    // 영화 데이터 저장
    useEffect(() => {
        axios.get('https://raw.githubusercontent.com/xoxorbrb/xoxorbrb/main/data.json')
            .then((res) => {
        ...
        <>
            ...
            </div>
            {
                ...
                MyrecommendMovie.length > 0 ?
                        ...
                        return (
                            <>
                                <div className={style.recommendMovieList}>
                                    <h4>{firstMovie.title}과(와) 비슷한 장르</h4>
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <img
                                                            ...
                                                            onClick={() => {
                                                                navigate(`/detail/${recommnedmovie}`);
                                                            }}
                                                        />
                                                    </div>
                                                );
                    ...
                    : <><div><h4 style={{ color: '#fff' }}>추천할 영화가 없습니다</h4></div></>
            }
        </>
    );
}
